...
#From the learning curves, you can see that the validation loss remains near a constant minimum 
# even though the training loss continues to decrease. 
...
history_df.loc[0:, ['loss', 'val_loss']].plot()
print(("Minimum Validation Loss: {:0.4f}").format(history_df['val_loss'].min()))
# ou can see that adding batch normalization was a big improvement on the first attempt! 
